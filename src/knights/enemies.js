...
export const ENEMIES = {
  ...
  phantom:   { name: 'Mirror Self',    sprite: 'npc/songjiang',   el: 'water', drop: 'boss',
...
export function makeEnemy(typeId, level = 1) {
  ...
  return {
    id: ++_eid,
    typeId, name: t.name, sprite: t.sprite, el: t.el,
